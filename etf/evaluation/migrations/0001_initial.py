    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('DRAFT', 'Draft'), ('CIVIL_SERVICE', 'Civil Service'), ('PUBLIC', 'Public')], default='DRAFT', max_length=256)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('conformity', models.CharField(blank=True, choices=[('FULL', 'Full'), ('PARTIAL', 'Partial'), ('NO', 'No')], max_length=10, null=True)),
                ('description', models.TextField(blank=True, null=True)),
                ('evaluation', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='process_standard', to='evaluation.evaluation')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('primary_or_secondary', models.CharField(blank=True, choices=[('PRIMARY', 'Primary'), ('SECONDARY', 'Secondary')], max_length=10, null=True)),
                ('direct_or_surrogate', models.CharField(blank=True, choices=[('DIRECT', 'Direct'), ('SURROGATE', 'Surrogate')], max_length=10, null=True)),
                ('description', models.TextField(blank=True, null=True)),
                ...
                ('evaluation', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='outcome_measures', to='evaluation.evaluation')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True, null=True)),
                ('collection_process', models.TextField(blank=True, null=True)),
                ('evaluation', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='other_measures', to='evaluation.evaluation')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('evaluation', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='interventions', to='evaluation.evaluation')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('modified_at', models.DateTimeField(auto_now=True)),
                ('name', models.CharField(blank=True, choices=[('EVALUATION_START', 'Evaluation start'), ('EVALUATION_END', 'Evaluation end'), ('FIRST_PARTICIPANT_RECRUITED', 'First participant recruited'), ('LAST_PARTICIPANT_RECRUITED', 'Last participant recruited'), ('INTERVENTION_START_DATE', 'Intervention start date'), ('INTERVENTION_END_DATE', 'Intervention end date'), ('INTERIM_DATA_EXTRACTION_DATE', 'Interim data extraction date'), ('INTERIM_DATA_ANALYSIS_START', 'Interim data analysis start'), ('INTERIM_DATA_ANALYSIS_END', 'Interim data analysis end'), ('PUBLICATION_INTERIM_RESULTS', 'Publication of interim results'), ('FINAL_DATA_EXTRACTION_DATE', 'Final data extraction date'), ('FINAL_DATA_ANALYSIS_START', 'Final data analysis start'), ('FINAL_DATA_ANALYSIS_END', 'Final data analysis end'), ('PUBLICATION_FINAL_RESULTS', 'Publication of final results'), ('OTHER', 'Other')], max_length=256, null=True)),
                ('date', models.DateField(blank=True, null=True)),
                ('type', models.CharField(blank=True, max_length=10, null=True)),
                ('reasons_for_change', models.TextField(blank=True, null=True)),
                ('evaluation', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='event_date', to='evaluation.evaluation')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.CharField(blank=True, choices=[('IMPACT', 'Impact evaluation'), ('PROCESS', 'Process evaluation'), ('ECONOMIC_COST_MINIMISATION', 'Economic evaluation: Cost-minimisation analysis'), ('ECONOMIC_COST_EFFECTIVENESS', 'Economic evaluation: Cost-effectiveness analysis'), ('ECONOMIC_COST_BENEFIT', 'Economic evaluation: Cost-benefit analysis'), ('ECONOMIC_COST_UTILITY', 'Economic evaluation: Cost-utility'), ('OTHER', 'Other')], max_length=256, null=True)),
                ('other_description', models.CharField(blank=True, max_length=256, null=True)),
                ('evaluation', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='evaluation_types', to='evaluation.evaluation')),
            ],
        ),
        migrations.CreateModel(
            name='Document',
            fields=[
                ...
                ('description', models.TextField(blank=True, null=True)),
                ('evaluation', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='documents', to='evaluation.evaluation')),
            ],
            options={
                'abstract': False,
            },
