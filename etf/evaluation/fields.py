...
economic_analysis_tooltip_text = {
...
economic_findings_tooltip_text = {
...
ethics_tooltip_text = {
    ...
    "participant_involvement": ["Have participants / potential participants been involved in the design of the study?"],
    "participant_consent": [
...
evaluation_cost_tooltip_text = {
    "evaluation_cost_earliest_spend_date": [
    ...
    "evaluation_cost_latest_spend_date": [
        "If possible, please provide at least approximate dates on when expenditure might be incurred in relation to this cost area. Even approximate dates, such as narrowing costs down to a year, will give future users a sense of whether they need to adjust these figures for inflation to intrepret them."
    ],
}

evaluation_type_tooltip_text = {
    "evaluation_type": [
...
event_date_tooltip_text = {
    "event_date_reasons_for_change": [
...
intervention_tooltip_text = {
    "intervention_brief_description": [
    ...
    "intervention_name": ["Please provide a name or brief phrase that describes the intervention."],
    "intervention_provider_description": [
...
issue_description_tooltip_text = {
    "issue_description": [
...
other_analysis_tooltip_text = {
    "other_eval_analysis_description": [
        "Description providing sufficient detail that a suitably experienced person would be able to duplicate the analysis based on the information provided."
    ],
}

other_design_tooltip_text = {
...
other_measures_tooltip_text = {
    "other_measures_description": [
    ...
    "other_measures_collection_process": ["How will data be collected, by whom, and when?"],
}

outcome_measure_tooltip_text = {
    "outcome_measure_primary_or_secondary": [
    ...
    "outcome_measure_minimum_difference": [
...
participant_recruitment_tooltip_text = {
...
process_analysis_tooltip_text = {
    "process_eval_analysis_description": [
        "Description providing sufficient detail that a suitably experienced person would be able to duplicate the analysis based on the information provided."
    ],
}

processes_standard_tooltip_text = {
    "processes_standard_name": [
...
studied_population_tooltip_text = {
    "studied_population": [
...
def get_field_tooltip_text(field_name):
    return field_tooltip_text[field_name]
